...
export function SecondSection() {
  return (
    <section className="section-2 mb-16 mt-[36%] flex flex-col items-center justify-center rounded-bl-[6rem] rounded-tr-[6rem] bg-[#2c2d3f] px-2 pb-20 lg:mb-36 lg:mt-0 lg:h-[58vh] lg:flex-row lg:px-16 xl:px-32 ">
      <img
